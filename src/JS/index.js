/*
    Objetivo 1 - quando o usuário clicar no botão mostrar mais deve abrir os projetos que 
    ...
    bjetivo 2 - esconder o botão mostrar mais.
...
botaoMostrarProjetos.addEventListener('click', () => {
    mostrarMaisProjetos();
    esconderBotao();
}) // arrow function - bloco de execução da função
...
function mostrarMaisProjetos() {
    projetosInativos.forEach(projetoInativo => {
        projetoInativo.classList.add('mostrar');
